...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: `Nguyễn Hồng Cường - Blog's của tôi - Để chút thương gửi vào trong gió, để chút buồn gửi vào trong tim...`,
    },
    {
      property: 'og:title',
      content: `Nguyễn Hồng Cường - Blog's của tôi - Để chút thương gửi vào trong gió, để chút buồn gửi vào trong tim...`,
          ...
          <div class="min-h-[calc(100vh+1rem)]">
            ...
            >
              <article
                ...
                :key="article._path"
                class="flex flex-col items-center gap-4 md:flex-row lg:gap-6 shadow-xl rounded-lg p-4 dark:bg-gray-600"
              >
                <AwesomeLink
                  :to="article._path"
                ...
                <div class="flex flex-col gap-2">
                  ...
                  >
                    <AwesomeLink
                      :to="article._path"
                      class="transition duration-100 hover:text-rose-500 active:text-rose-600 line-clamp-1 dark:text-slate-100"
                      >{{ article.title }}</AwesomeLink
                    >
                  </h2>

                  <p class="text-gray-500 line-clamp-2 dark:text-slate-300">
                    {{ article.description }}
                  </p>
